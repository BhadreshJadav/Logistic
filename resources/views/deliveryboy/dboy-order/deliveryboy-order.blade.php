...
<head>
  ...
  <meta charset="utf-8">
  <meta name="keywords" content="Orders Details">
  <meta name="description" content="">
  <meta name="page_type" content="np-template-header-footer-from-plugin">
  <title>deliveryboy-order</title>
  <link rel="stylesheet" href="{{asset ('css/admin/nicepage.css')}}" media="screen">
  <link rel="stylesheet" href="{{asset('css/deliveryboy/deliveryboy-order.css')}}" media="screen">
  ...
  <meta property="og:title" content="deliveryboy-order">
