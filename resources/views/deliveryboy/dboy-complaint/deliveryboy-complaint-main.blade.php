...
<head>
  ...
  <title>deliveryboy-complaint-main</title>
  <link rel="stylesheet" href="{{asset ('css/admin/nicepage.css')}}" media="screen">
  <link rel="stylesheet" href="{{asset('css/deliveryboy/deliveryboy-complaint-main.css')}}" media="screen">
  ...
  <meta property="og:title" content="deliveryboy-complaint-main">
...
<body class="u-body u-xl-mode">
  ...
  <section class="u-clearfix u-section-1" id="sec-1813">
    <div class="u-align-left u-clearfix u-sheet u-sheet-1"><span class="u-file-icon u-icon u-icon-1"
        data-href="{{url('deliveryboy-home')}}" data-page-id="83402580"><img src="{{asset('images/p-images/8541839.png')}}" alt=""></span>
        ...
        <div class="u-container-layout u-container-layout-1">
          <div class="u-border-2 u-border-grey-5 u-container-style u-group u-radius-20 u-shape-round u-group-2">
            <div class="u-container-layout u-container-layout-2"><span class="u-file-icon u-icon u-icon-2"><img
                  src="{{asset('images/p-images/customer-review1.png')}}" alt=""></span>
              <a href="{{url('deliveryboy-view-complaint')}}" data-page-id="175646629"
                class="u-border-2 u-border-black u-btn u-btn-round u-button-style u-hover-palette-1-light-2 u-none u-radius-10 u-text-body-color u-text-hover-black u-btn-1">view
                complaints</a>
            </div>
          </div>
          <div class="u-border-2 u-border-grey-5 u-container-style u-group u-radius-20 u-shape-round u-group-3">
            <div class="u-container-layout u-container-layout-3"><span class="u-file-icon u-icon u-icon-3"><img
                  src="{{asset('images/p-images/bad-review.png')}}" alt=""></span>
              <a href="{{url('deliveryboy-add-complaint')}}" data-page-id="58387832"
