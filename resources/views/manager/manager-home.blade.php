...
<head>
  ...
  <link rel="stylesheet" href="{{asset('css/manager/manager-home.css')}}" media="screen">
  ...
  <meta property="og:title" content="manager-home">
...
<body class="u-body u-overlap u-xl-mode">
  ...
  <section class="u-clearfix u-section-1" id="sec-2bc2">
        ...
        <div class="u-container-layout u-container-layout-1">
          <div class="u-border-2 u-border-grey-5 u-container-style u-group u-radius-20 u-shape-round u-group-2">
            <div class="u-container-layout u-container-layout-2"><span class="u-file-icon u-icon u-icon-1"><img
                  src="{{asset('images/p-images/order.png')}}" alt=""></span>
              <a href="{{url('manager-order-main')}}" data-page-id="414128621"
                class="u-border-2 u-border-black u-btn u-btn-round u-button-style u-hover-palette-1-light-2 u-none u-radius-10 u-text-body-color u-text-hover-black u-btn-1">Orders<span
                  style="font-size: 0.875rem;"></span>
              </a>
            </div>
          </div>
          <div class="u-border-2 u-border-grey-5 u-container-style u-group u-radius-20 u-shape-round u-group-3">
            <div class="u-container-layout u-container-layout-3"><span class="u-file-icon u-icon u-icon-2"><img
                  src="{{asset('images/p-images/delivery-boy.png')}}" alt=""></span>
              <a href="{{asset('manager-deliveryboy-main')}}" data-page-id="10844003"
                class="u-border-2 u-border-black u-btn u-btn-round u-button-style u-hover-palette-1-light-2 u-none u-radius-10 u-text-body-color u-text-hover-black u-btn-2">Delivey
                Boy</a>
            </div>
          </div>
        </div>
