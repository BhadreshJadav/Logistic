...
<head>
  ...
  <link rel="stylesheet" href="{{asset('css/manager/manager-profile.css')}}" media="screen">
  ...
  <meta property="og:title" content="manager-profile">
...
<body class="u-body u-xl-mode">
  ...
  <section class="u-clearfix u-section-1" id="sec-179c">
  <div class="card-body">
            @if (session('success'))
    ...
    <div class="u-clearfix u-sheet u-sheet-1">
      <img class="u-image u-image-default u-preserve-proportions u-image-1" src="{{asset('images/p-images/85418314.png')}}" alt=""
        data-image-width="128" data-image-height="128" data-href="{{url('manager-home')}}" data-page-id="84728025">
      ...
      <div class="u-border-2 u-border-grey-5 u-container-style u-group u-shape-rectangle u-group-1">
        <div class="u-container-layout u-container-layout-1">
          <img class="u-image u-image-default u-preserve-proportions u-image-2" src="{{asset('images/p-images/profile-4.png')}}" alt=""
