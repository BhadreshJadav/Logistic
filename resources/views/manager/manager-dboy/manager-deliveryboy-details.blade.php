...
<head>
  ...
  <title>manager-deliveryboy-details</title>
  <link rel="stylesheet" href="{{asset ('css/admin/nicepage.css')}}" media="screen">
  <link rel="stylesheet" href="{{asset('css/manager/manager-deliveryboy-details.css')}}" media="screen">
  ...
  <meta property="og:title" content="manager-deliveryboy-details">
...
<body class="u-body u-xl-mode">
  ...
  <section class="u-clearfix u-section-1" id="sec-3e2f">
        ...
        <table class="u-table-entity">
          ...
          <thead class="u-align-center u-grey-80 u-table-header u-table-header-1">
            ...
            <tr style="height: 36px;">
             <th class="u-border-1 u-border-grey-50 u-table-cell u-table-cell-3">DeliveryBoy ID</th>
