...
<head>
  ...
  <title>manager-deliveryboy-main</title>
  <link rel="stylesheet" href="{{asset ('css/admin/nicepage.css')}}" media="screen">
  <link rel="stylesheet" href="{{asset('css/manager/manager-deliveryboy-main.css')}}" media="screen">
  ...
  <meta property="og:title" content="manager-deliveryboy-main">
...
<body class="u-body u-xl-mode">
  <header class="u-border-2 u-border-palette-1-light-2 u-clearfix u-header u-palette-1-light-3 u-header" id="sec-b07d">
    <div class="u-align-left u-clearfix u-sheet u-sheet-1"><span
        class="u-file-icon u-icon u-text-palette-1-base u-icon-1" data-href="{{url('manager-home')}}"
      ...
      <p class="u-text u-text-palette-1-base u-text-1">
        <a class="u-active-none u-border-none u-btn u-button-link u-button-style u-hover-none u-none u-text-palette-1-base u-btn-1"
          href="{{url('manager-home')}}" data-page-id="84728025">FASTER </a>
      </p>
    </div>
  </header>
  <section class="u-clearfix u-section-1" id="sec-1042">
    <div class="u-align-left u-clearfix u-sheet u-sheet-1"><span class="u-file-icon u-icon u-icon-1"
        data-href="{{url('manager-home')}}" data-page-id="84728025"><img src="{{asset('images/p-images/854183.png')}}" alt=""></span>
        ...
        <div class="u-container-layout u-container-layout-1">
          <div class="u-border-2 u-border-grey-5 u-container-style u-group u-radius-20 u-shape-round u-group-2">
            <div class="u-container-layout u-container-layout-2"><span class="u-file-icon u-icon u-icon-2"><img
                  src="{{asset('images/p-images/businessman.png')}}" alt=""></span>
              <a href="{{url('manager-deliveryboy-details')}}" data-page-id="130209318"
                class="u-border-2 u-border-black u-btn u-btn-round u-button-style u-hover-palette-1-light-2 u-none u-radius-10 u-text-body-color u-text-hover-black u-btn-1">delivery
                boy details</a>
            </div>
          </div>
          <div class="u-border-2 u-border-grey-5 u-container-style u-group u-radius-20 u-shape-round u-group-3">
            <div class="u-container-layout u-container-layout-3"><span class="u-file-icon u-icon u-icon-3"><img
                  src="{{asset('images/p-images/delivery-boy-2.png')}}" alt=""></span>
              <a href="{{url('add-new-deliveryboy')}}" data-page-id="375222527"
                class="u-border-2 u-border-black u-btn u-btn-round u-button-style u-hover-palette-1-light-2 u-none u-radius-10 u-text-body-color u-text-hover-black u-btn-2">add
                new delivery boy</a>
            </div>
          </div>
        </div>
