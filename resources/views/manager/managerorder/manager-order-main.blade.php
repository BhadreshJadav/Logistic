...
<head>
  ...
  <title>manager-order-main</title>
  <link rel="stylesheet" href="{{asset ('css/admin/nicepage.css')}}" media="screen">
  <link rel="stylesheet" href="{{asset('css/manager/manager-order-main.css')}}" media="screen">
  ...
  <meta property="og:title" content="manager-order-main">
...
<body class="u-body u-xl-mode">
  ...
  <section class="u-clearfix u-section-1" id="sec-54a7">
        ...
        <div class="u-container-layout u-container-layout-1">
          <div class="u-border-2 u-border-grey-5 u-container-style u-group u-radius-20 u-shape-round u-group-2">
            <div class="u-container-layout u-container-layout-2"><span class="u-file-icon u-icon u-icon-2"><img
                  src="{{asset('images/p-images/currentorder.png')}}" alt=""></span>
              <a href="{{url('manager-current-order')}}" data-page-id="54942144"
                class="u-border-2 u-border-black u-btn u-btn-round u-button-style u-hover-palette-1-light-2 u-none u-radius-10 u-text-body-color u-text-hover-black u-btn-1">Current
                Orders</a>
            </div>
          </div>
          <div class="u-border-2 u-border-grey-5 u-container-style u-group u-radius-20 u-shape-round u-group-3">
            <div class="u-container-layout u-container-layout-3"><span class="u-file-icon u-icon u-icon-3"><img
                  src="{{asset('images/p-images/completeorder.png')}}" alt=""></span>
              <a href="{{url('manager-complete-order')}}" data-page-id="657721012"
                class="u-border-2 u-border-black u-btn u-btn-round u-button-style u-hover-palette-1-light-2 u-none u-radius-10 u-text-body-color u-text-hover-black u-btn-2">Completed
                Orders</a>
            </div>
          </div>
        </div>
