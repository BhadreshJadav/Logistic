...
<head>
  ...
  <title>manager-current-order</title>
  <link rel="stylesheet" href="{{asset ('css/admin/nicepage.css')}}" media="screen">
  <link rel="stylesheet" href="{{asset('css/manager/manager-current-order.css')}}" media="screen">
  ...
  <meta property="og:title" content="manager-current-order">
...
<body class="u-body u-xl-mode">
  ...
  <section class="u-clearfix u-section-1" id="sec-ef2c">
    <div class="u-clearfix u-sheet u-sheet-1"><span class="u-file-icon u-icon u-icon-1"
      ...
      <form action="{{ route('manager-current-order') }}" method="get" class="u-clearfix  u-form-spacing-15 u-inner-form"
