...
<head>
  ...
  <meta charset="utf-8">
  <meta name="keywords" content="Completed Orders Details">
  <meta name="description" content="">
  <meta name="page_type" content="np-template-header-footer-from-plugin">
  <title>manager-complete-order</title>
  <link rel="stylesheet" href="{{asset ('css/admin/nicepage.css')}}" media="screen">
  <link rel="stylesheet" href="{{asset('css/manager/manager-complete-order.css')}}" media="screen">
  ...
  <meta property="og:title" content="manager-complete-order">
