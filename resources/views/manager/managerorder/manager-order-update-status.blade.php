...
<head>
  ...
  <meta charset="utf-8">
  <meta name="keywords" content="Order Update Status">
  <meta name="description" content="">
  <meta name="page_type" content="np-template-header-footer-from-plugin">
  <title>manager-order-update-status</title>
  <link rel="stylesheet" href="{{asset ('css/admin/nicepage.css')}}" media="screen">
  <link rel="stylesheet" href="{{asset('css/manager/manager-order-update-status.css')}}" media="screen">
...
<body class="u-body u-xl-mode">
  ...
  <section class="u-clearfix u-section-1" id="sec-e9e2">
    <div class="u-clearfix u-sheet u-sheet-1">
      <img class="u-image u-image-default u-preserve-proportions u-image-1" src="{{asset('images/p-images/85418311.png')}}" alt=""
        data-image-width="128" data-image-height="128" data-href="{{url('manager-current-order')}}" data-page-id="54942144">
      <h2 class="u-align-center u-text u-text-default u-text-1">Order Update Status</h2>
