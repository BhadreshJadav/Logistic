...
<head>
  ...
  <link rel="stylesheet" href="{{asset('css/admin/admin-user-details.css')}}" media="screen">
  ...
  <meta property="og:title" content="admin-user-details">
...
{{--          remvoe one by one class to check--}}
        <form action="{{ route('admin-user-details') }}" method="get" class="u-clearfix  u-form-spacing-15 u-inner-form"
          ...
          <div class="u-form-group u-form-name u-label-none fg">
            ...
            <input type="search" placeholder="Enter User Name" id="name-ef64" name="search"
