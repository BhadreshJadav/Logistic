...
<head>
  ...
  <link rel="stylesheet" href="{{asset ('css/admin/admin-profile.css')}}" media="screen">
  ...
  <section class="u-clearfix u-section-1" id="sec-0e29">
    <div class="u-clearfix u-sheet u-sheet-1">
      <img class="u-image u-image-default u-preserve-proportions u-image-1" src="{{asset ('images/p-images/854183142.png')}}" alt=""
        data-image-width="128" data-image-height="128" data-href="{{url('admin-home')}}" data-page-id="84728025">
      ...
      <div class="u-border-2 u-border-grey-5 u-container-style u-group u-shape-rectangle u-group-1">
        <div class="u-container-layout u-container-layout-1">
          <img class="u-image u-image-default u-preserve-proportions u-image-2" src="{{asset('images/p-images/profile.png')}}" alt=""
