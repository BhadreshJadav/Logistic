...
<head>
  ...
  <meta charset="utf-8">
  <meta name="keywords" content="Users Complaints">
  <meta name="description" content="">
  <meta name="page_type" content="np-template-header-footer-from-plugin">
  <title>admin-deliveryboy-complaints</title>
  <link rel="stylesheet" href="{{asset ('css/admin/nicepage.css')}}" media="screen">
  <link rel="stylesheet" href="{{asset('css/admin/admin-deliveryboy-complaints.css')}}" media="screen">
  ...
  <meta property="og:title" content="admin-deliveryboy-complaints">
        ...
        <table class="u-table-entity">
          ...
          <thead class="u-align-center u-grey-80 u-table-header u-table-header-1">
            <tr style="height: 40px;">
              <th class="u-border-1 u-border-grey-50 u-table-cell u-table-cell-1">Delivery boy ID</th>
              <th class="u-border-1 u-border-grey-50 u-table-cell u-table-cell-2">Subject</th>
              <th class="u-border-1 u-border-grey-50 u-table-cell u-table-cell-3">Description</th>
