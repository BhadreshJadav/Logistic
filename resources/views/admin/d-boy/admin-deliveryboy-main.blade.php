...
<head>
  ...
  <title>admin-deliveryboy-main</title>
  <link rel="stylesheet" href="{{asset ('css/admin/nicepage.css')}}" media="screen">
  <link rel="stylesheet" href="{{asset('css/admin/admin-deliveryboy-main.css')}}" media="screen">
  ...
  <meta property="og:title" content="admin-deliveryboy-main">
...
<body class="u-body u-xl-mode">
  ...
  <section class="u-clearfix u-section-1" id="sec-e8e7">
    <div class="u-align-left u-clearfix u-sheet u-sheet-1"><span class="u-file-icon u-icon u-icon-1"
        data-href="{{url('admin-home')}}" data-page-id="26765029"><img src="{{asset('images/p-images/85418320.png')}}" alt=""></span>
        ...
        <div class="u-container-layout u-valign-top-md u-valign-top-sm u-valign-top-xs u-container-layout-1">
          <div class="u-border-2 u-border-grey-5 u-container-style u-group u-radius-20 u-shape-round u-group-2">
            <div class="u-container-layout u-container-layout-2"><span class="u-file-icon u-icon u-icon-2"><img
                  src="{{asset('images/p-images/details.png')}}" alt=""></span>
              <a href="{{url('admin-deliveryboy-details')}}" data-page-id="2588712900"
          ...
          <div class="u-border-2 u-border-grey-5 u-container-style u-group u-radius-20 u-shape-round u-group-3">
            <div class="u-container-layout u-container-layout-3"><span class="u-file-icon u-icon u-icon-3"><img
                  src="{{asset('images/p-images/complain1.png')}}" alt=""></span>
              <a href="{{url('admin-deliveryboy-complaints')}}" data-page-id="168194874"
                class="u-border-2 u-border-black u-btn u-btn-round u-button-style u-hover-palette-1-light-2 u-none u-radius-10 u-text-body-color u-text-hover-black u-btn-2">delivery
                boy complaints</a>
            </div>
          </div>
        </div>
