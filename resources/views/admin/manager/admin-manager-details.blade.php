...
<head>
  ...
  <meta charset="utf-8">
  <meta name="keywords" content="Manager Details">
  <meta name="description" content="">
  <meta name="page_type" content="np-template-header-footer-from-plugin">
  <title>admin-manager-details</title>
  <link rel="stylesheet" href="{{asset ('css/admin/nicepage.css')}}" media="screen">
  <link rel="stylesheet" href="{{asset ('css/admin/admin-manager-details.css')}}" media="screen">
  ...
  <meta property="og:title" content="admin-manager-details">
