...
<head>
  ...
  <title>admin-completed-order</title>
  <link rel="stylesheet" href="{{asset ('css/admin/nicepage.css')}}" media="screen">
  <link rel="stylesheet" href="{{asset('css/admin/admin-completed-order.css')}}" media="screen">
  ...
  <meta property="og:title" content="admin-completed-order">
...
<body class="u-body u-xl-mode">
  <header class="u-border-2 u-border-palette-1-light-2 u-clearfix u-header u-palette-1-light-3 u-header" id="sec-b07d">
    <div class="u-align-left u-clearfix u-sheet u-sheet-1"><span
        ...
        data-page-id="84728025"><img src="images/p-images/1.png" alt=""></span>
  ...
  <section class="u-clearfix u-section-1" id="sec-d194">
    <div class="u-clearfix u-sheet u-sheet-1"><span class="u-file-icon u-icon u-icon-1"
      ...
      <form action="{{ route('admin-completed-order') }}" method="get" class="u-clearfix  u-form-spacing-15 u-inner-form"
