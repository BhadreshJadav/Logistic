...
<head>
  ...
  <title>user-view-complaint</title>
  <link rel="stylesheet" href="{{asset ('css/admin/nicepage.css')}}" media="screen">
  <link rel="stylesheet" href="{{asset('css/user/user-view-complaint.css')}}" media="screen">
  ...
  <meta property="og:title" content="user-view-complaint">
