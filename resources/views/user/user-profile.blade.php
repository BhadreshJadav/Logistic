...
<head>
  ...
  <link rel="stylesheet" href="{{asset('css/user/user-profile.css')}}" media="screen">
...
<body class="u-body u-xl-mode">
  ...
  <section class="u-clearfix u-section-1" id="sec-31bc">
    <div class="u-clearfix u-sheet u-sheet-1">
      ...
      <div class="u-border-2 u-border-grey-5 u-container-style u-group u-shape-rectangle u-group-1">
        <div class="u-container-layout u-container-layout-1">
          <img class="u-image u-image-default u-preserve-proportions u-image-2" src="{{asset('images/p-images/profile-31.png')}}" alt=""
