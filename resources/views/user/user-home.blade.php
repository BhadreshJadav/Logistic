...
<head>
  ...
  <link rel="stylesheet" href="{{asset('css/user/user-home.css')}}" media="screen">
  ...
  <meta property="og:title" content="user-home">
...
<body class="u-body u-xl-mode">
  ...
  <section class="u-clearfix u-section-1" id="sec-c656">
        ...
        <div class="u-container-layout u-container-layout-1">
          <div class="u-border-2 u-border-grey-5 u-container-style u-group u-radius-20 u-shape-round u-group-2">
            <div class="u-container-layout u-container-layout-2"><span class="u-file-icon u-icon u-icon-1"><img
                  src="{{asset('images/p-images/trolley.png')}}" alt=""></span>
              <a href="{{url('user-order-main')}}" data-page-id="56826989"
          ...
          <div class="u-border-2 u-border-grey-5 u-container-style u-group u-radius-20 u-shape-round u-group-3">
            <div class="u-container-layout u-container-layout-3"><span class="u-file-icon u-icon u-icon-2"><img
                  src="{{asset('images/p-images/complaint.png')}}" alt=""></span>
              <a href="{{url('user-complaint-main')}}" data-page-id="37158205"
