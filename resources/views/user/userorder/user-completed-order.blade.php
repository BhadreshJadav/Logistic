...
<head>
  ...
  <title>user-completed-order</title>
  <link rel="stylesheet" href="{{asset ('css/admin/nicepage.css')}}" media="screen">
  <link rel="stylesheet" href="{{asset('css/user/user-completed-order.css')}}"  media="screen">
  ...
  <meta property="og:title" content="user-completed-order">
